...
if [ -z "${EVALROOT}" ]; then
    EVALROOT="$I/uvc-delins-eval/" #"$I/uvc/eval/"
fi

mkdir -p ${I}/public/software/
...
# UVC tools
UVC=${EVALROOT}/tools/uvc/uvc1 # ${I}/public/software/uvc-20211109/uvc1
UVCTN=${EVALROOT}/tools/uvc/uvcTN.sh # ${I}/public/software/uvc-20211109/uvcTN.sh
UVCdelins=${EVALROOT}/tools/uvc-delins/uvcvcf-raw2delins-all.sh # ${I}/public/software/uvc-delins-2022-0207/uvcvcf-raw2delins-all.sh
...
G1KV37=${EVALROOT}/datafiles/human_g1k_v37.fasta
